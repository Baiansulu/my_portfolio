...
<section className="mx-auto max-w-5xl px-4 py-16">
  ...
  <p className="mt-3 max-w-2xl text-slate-600">
    Motivated Computer Science student pursuing a BA with a minor in Business Administration. Skilled in
    software engineering, web development, and databases. Passionate about improving user experiences and
